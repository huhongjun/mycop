...
function window.onload() {
	...
	<logic:equal name="IsInfoServeForm4" property="actionType" value = "add">
	CellWeb1.OpenFile(getUrl() + "<bean:write  name="IsInfoServeForm4" property="templatePath" filter="true"/>","");
	</logic:equal>
	<logic:equal name="IsInfoServeForm4" property="actionType" value = "modify">
...
<logic:notEqual name="IsInfoServeForm4" property="actionType" value="modify">
<body class="bodybg">
</logic:notEqual>

<html:form action="/infoservice/managesystemedit" method="post" enctype="multipart/form-data">
<span id="idSpanTop" class="TableTitleText"><br></span> 

<table id="idTBTittle" width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
        <td align="center"><span class="TableTitleText" nowrap>管理制度编辑</span></td>
    </tr>
    <tr> 
...
<table width="95%" align="center">
    ...
    <html:hidden property="vo.info_flag" value="6"/>	
	...
	<logic:notEqual name="IsInfoServeForm4" property="vo.file_name" value="">
	<logic:equal name="IsInfoServeForm4" property="actionType" value="modify">
	<tr class="listcellrow">
...
<table id="idTBBottom" width="95%" border="0" cellspacing="0" cellpadding="0" style="POSITION:absolute; left: 0px; top: 600px;">
    ...
    <tr> 
        <td align="center"> 
		<goa:button property="save" value="保存" styleClass="button"  onclick="return savePlan()" operation="GLZD.OPT"/>
		<goa:button property="save" value="保存并返回" styleClass="button"  onclick="return savePlanExit()" operation="GLZD.OPT"/>
        <goa:button property="exit" value="返回" styleClass="button" onclick="doAction('goUrl(index)')" operation="GLZD.VIEW"/>
		</td>
    </tr>
</table>
</logic:equal>
...
<table id="idTBBottom" width="95%" border="0" cellspacing="0" cellpadding="0" style="POSITION:absolute; left: 0px; top: 600px;">
    ...
    <tr> 
        <td align="center"> 
		<goa:submit property="save" value="保存" styleClass="button"  onclick="setTempleteContent(e1.getValue());doSave(IsInfoServeForm4)" operation="GLZD.OPT"/>
		<goa:button property="save" value="保存并返回" styleClass="button"  onclick="setTempleteContent(e1.getValue());return doSaveExit(IsInfoServeForm4)" operation="GLZD.OPT"/>
        <goa:button property="exit" value="返回" styleClass="button" onclick="doAction('goUrl(index)')" operation="GLZD.VIEW"/>
		</td>
    </tr>
</table>
