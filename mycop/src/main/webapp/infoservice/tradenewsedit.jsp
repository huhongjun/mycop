...
<!--报表内容-->
<logic:equal name="IsInfoServeForm3" property="vo.editor_type" value="0">
...
function window.onload() {
	...
	<logic:equal name="IsInfoServeForm3" property="actionType" value = "add">
	CellWeb1.OpenFile(getUrl() + "<bean:write  name="IsInfoServeForm3" property="templatePath" filter="true"/>","");
	</logic:equal>
	<logic:equal name="IsInfoServeForm3" property="actionType" value = "modify">
	CellWeb1.OpenFile( getUrl() + "<bean:write  name="IsInfoServeForm3" property="cellname" filter="true"/>","");
	</logic:equal>
...
<logic:notEqual name="IsInfoServeForm3" property="vo.editor_type" value="0">
<SCRIPT LANGUAGE="JavaScript">
...
<logic:notEqual name="IsInfoServeForm3" property="actionType" value="modify">
<body class="bodybg">
</logic:notEqual>

<html:form action="/infoservice/tradenewsedit" method="post" enctype="multipart/form-data">
<span id="idSpanTop" class="TableTitleText"><br></span> 

<table id="idTBTittle" width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
        <td align="center"><span class="TableTitleText" nowrap>行业新闻编辑</span></td>
    </tr>
    <tr> 
        <td>&nbsp;<html:hidden name="IsInfoServeForm3" property="actionType"/></td>
    </tr>
</table>
...
<table width="95%" align="center">
    ...
    <html:hidden property="vo.info_flag" value="5"/>	
	...
	<logic:notEqual name="IsInfoServeForm3" property="vo.file_name" value="">
	<logic:equal name="IsInfoServeForm3" property="actionType" value="modify">
	<tr class="listcellrow">
...
<table id="idTBBottom" width="95%" border="0" cellspacing="0" cellpadding="0" style="POSITION:absolute; left: 0px; top: 600px;">
    ...
    <tr> 
        <td align="center"> 
		<goa:button property="save" value="保存" styleClass="button"  onclick="return savePlan()" operation="HYXW.OPT"/>
		<goa:button property="save" value="保存并返回" styleClass="button"  onclick="return savePlanExit()" operation="HYXW.OPT"/>
...
<table id="idTBBottom" width="95%" border="0" cellspacing="0" cellpadding="0" style="POSITION:absolute; left: 0px; top: 600px;">
    ...
    <tr> 
        <td align="center"> 
		<goa:submit property="save" value="保存" styleClass="button"  onclick="setTempleteContent(e1.getValue());doSave(IsInfoServeForm3)" operation="HYXW.OPT"/>
		<goa:button property="save" value="保存并返回" styleClass="button"  onclick="setTempleteContent(e1.getValue());return doSaveExit(IsInfoServeForm3)" operation="HYXW.OPT"/>
        <goa:button property="exit" value="返回" styleClass="button" onclick="doAction('goUrl(index)')" operation="HYXW.VIEW"/>
		</td>
    </tr>
</table>
