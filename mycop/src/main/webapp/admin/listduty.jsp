...
<table width="95%" border="0" align="center" cellpadding="1" cellspacing="1">
	...
	<tr> 
	<td colspan="6" align="center" class="TableTitleText">职务信息</td>
	</tr>
	<tr> 
	...
	<tr>
	<td>
	<goa:button styleClass="button"  property="add" onclick="doAdd()" value="新增" operation="ZWWF.OPT"/>
	</td>
	<td> <goa:button  styleClass="button" property="delete" value="删除"  onclick="doDelete()"operation="ZWWF.OPT"/>
	<td>
	<goa:button styleClass="button"  property="copy" onclick="toUrl('../admin/editduty.do?actionType=modify',true)" value="修改"operation="ZWWF.OPT"/>
	</td>
  	<td> <goa:button  styleClass="button" property="delete" value="查看"  onclick="toUrl('../admin/viewduty.do',true)"operation="ZWWF.VIEW"/></td>
	</tr>
	</table>
	</td>
  </tr>
	...
	<table width="100%" border="0" bordercolor="red" cellpadding="2" cellspacing="0" align="center">
        <tr height="20">
           <td width="30" align="center" height="11" class="Listtitle"><input alt="" type="checkbox" name="selectall" onclick="selectAllChk(this)"></td>
			<td width="25%" id=".duty_code" onclick="onchangeOrderBy(this)"class="Listtitle"><div>职务代码</div></td>
      			<td width="25%" id=".duty_name" onclick="onchangeOrderBy(this)"class="Listtitle"><div>职务名称</div></td>
