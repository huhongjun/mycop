...
<table width="95%" border="0" align="center" cellpadding="1" cellspacing="1">
	...
	<tr> 
	<td colspan="6" align="center" class="TableTitleText">性别信息</td>
	</tr>
	<tr> 
	...
	<tr>
	<td>
	<goa:button styleClass="button"  property="add" onclick="doAdd()" value="新增" operation="XBWF.OPT"/>
	</td>
	<td> <goa:button  styleClass="button" property="delete" value="删除"  onclick="doDelete()" operation="XBWF.OPT"/>
	<td>
	<goa:button styleClass="button"  property="copy" onclick="toUrl('../admin/editsex.do?actionType=modify',true)" value="修改" operation="XBWF.OPT"/>
	</td>
  	<td> <goa:button  styleClass="button" property="delete" value="查看"  onclick="toUrl('../admin/viewsex.do',true)" operation="XBWF.VIEW"/></td>
	</tr>
	</table>
	</td>
  </tr>
  <tr> 
	...
	<table width="100%" border="0"  cellpadding="2" cellspacing="0"  align="center">
        <tr height="20">
			...
			<td width="25%" id=".sex_code" onclick="onchangeOrderBy(this)" class="Listtitle"><div>性别代码</div></td>
      			<td width="25%" id=".sex_name" onclick="onchangeOrderBy(this)" class="Listtitle"><div>性别名称</div></td>
