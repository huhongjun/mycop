...
<table align="center">
  ...
  <tr>
    <td align="center" >  <html:submit styleClass="button"  property="create" value="确定"  onclick="setSubmitAble();toSelectAction(this,'addRightListBox','userId','setDepartmentUser')"/>
              <html:button styleClass="button" property="reset" value="重置" onclick="javascript:reSetSelect();"/>
    <html:submit  styleClass="button"  property="list" value="返回" onclick="setSubmitAble();toAction(this,'list')"/></td>
