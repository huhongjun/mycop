...
<table align="center">
  ...
  <tr>
    <td align="center" >  <html:submit styleClass="button" property="create" value="确定" onclick="javascript:setSubmitAble();toSelectAction(this,'addRightListBox','jobId','setJobUser')"/>
