...
<%
 ...
 out.println("var tree = new WebFXTree('角色管理')");
 out.println("tree.setBehavior('classic')");
 out.println("var a;");
 out.println("var list='"+request.getContextPath()+"/privilege/roleAction.do?action=list';");
 out.println("var a= new WebFXTreeItem('角色列表','javascript:toAction(list)')");
 out.println("tree.add(a);");
// out.println("var b;");
// out.println("var rtree='"+request.getContextPath()+"/jsp/privilege/res_opt.jsp';");
// out.println("var b= new WebFXTreeItem('角色权限','javascript:toAction(rtree)')");
