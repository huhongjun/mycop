...
<%
  ...
  String src=request.getContextPath()+"/privilege/resourceAction.do?action=getTreeChild&resid=0";
  String action="#";
...
<body OnUnload="window.returnValue = document.all('resid').value;window.close();">
...
<form  target="_self">
   <input type="hidden" id="resid" name="resid" value="<%=request.getParameter("value")%>">
</form >
</body>
</html>
