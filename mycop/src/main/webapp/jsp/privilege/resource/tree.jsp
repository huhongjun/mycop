...
function selectNode(id){
    window.location="<%= viewAction%>&id=" + id;
    //if(id=='(??)')id='/';
    //window.opener.self.document.SYNCPROP.tempFolder.value = id;
    //if (top.window.opener.copySelection) {
    //    top.window.opener.copySelection();
    //}
}
//-->
</script>
