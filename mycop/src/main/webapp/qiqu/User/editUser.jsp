  ...
  <center>
	...
	<td align="center">
        ...
        <td align="center" colspan="2"> 
			          <goa:button property="save" value="保存" styleClass="button"  onclick="return doSave(UserForm)" operation="TSGL.OPT"/>
		          <goa:button property="save" value="保存并返回" styleClass="button"  onclick="return doSaveExit(UserForm)" operation="TSGL.OPT"/>
