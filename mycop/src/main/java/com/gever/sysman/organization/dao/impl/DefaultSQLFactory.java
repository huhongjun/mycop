 ...
 * @author Hu.Walker
 */
public class DefaultSQLFactory
    implements com.gever.sysman.organization.dao.SQLFactory {
    private static Properties m_queries = null;
    private static String SQLFile = "com/gever/sysman/organization/dao/impl/sql.properties";
