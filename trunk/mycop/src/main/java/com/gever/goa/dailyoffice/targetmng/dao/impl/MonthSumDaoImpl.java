...
import com.gever.goa.dailyoffice.targetmng.vo.MonthSumTreeVO;
...
/**
 * Title: 月度总结Dao接口实现类 Description: 月度总结Dao接口实现类 Copyright: Copyright (c) 2004
 * Company: 天行软件
 *
 * @author Hu.Walker
 * @version 1.0
...
public class MonthSumDaoImpl
    extends BaseDAO
    implements MonthSumDao {
  ...
  public MonthSumDaoImpl(String dbData) {
    super(dbData);
  }
  ...
  public List getTreeData(String nodeid,String curDeptId) throws DefaultException {
         ...
         MonthSumTreeVO vo = new MonthSumTreeVO();
