...
public class IsDoTypeAction extends BaseAction {
    ...
    protected String toList(GoaActionConfig cfg)
        ...
        if (!"".equals(paraFlag)) {
            ...
            if (!StringUtils.isNull(nodeid)) {
                form.setSqlWhere(" and is_dotype.moduleflag= '" + paraFlag +
                    "'" + " and is_dotype.parent_type='" + nodeid + "'");
            } else {
                form.setSqlWhere(" and is_dotype.moduleflag= '" + paraFlag +
                    "'" +
                    " and (is_dotype.parent_type='' or is_dotype.parent_type is null) ");
            }
        } else {
            ...
            form.setSqlWhere(" AND IS_DOTYPE.INFO_TYPE LIKE '%" +
                paraSimpleQuery + "%'");
        }
    ...
    protected String doInsert(GoaActionConfig cfg, boolean isBack)
        ...
        try {
            ...
            if (e.getMessage().equals("PK repeat!")) {
                request.setAttribute("ErrorMsg", "类别名称已存在,请重新输入！");
    ...
    public String doTreeData(GoaActionConfig cfg)
        ...
        cfg.getRequest().setAttribute("treeData",
            isDoTypeDao.getTreeData(paraFlag, nodeid));
...
//    	IsDoTypesForm form=(IsDoTypesForm)cfg.getBaseForm();
        ...
        staticVO1.setNodename("资源共享");
        staticVO1.setAction(
            "/infoservice/typelist.do?paraFlag=0&#38;nodeid=null");
        staticVO1.setIsfolder("1");
        staticVO1.setSrc(
            "/infoservice/typetree.do?action=doTreeData&#38;paraFlag=0");
        ...
        staticVO2.setAction(
            "/infoservice/typelist.do?paraFlag=1&#38;nodeid=null");
        staticVO2.setNodename("政策法规");
        staticVO2.setIsfolder("1");
        staticVO2.setSrc(
            "/infoservice/typetree.do?action=doTreeData&#38;paraFlag=1");
        ...
        staticVO3.setAction(
            "/infoservice/typelist.do?paraFlag=2&#38;nodeid=null");
        staticVO3.setNodename("公司动态");
        staticVO3.setIsfolder("1");
        staticVO3.setSrc(
            "/infoservice/typetree.do?action=doTreeData&#38;paraFlag=2");
        ...
        staticVO4.setAction(
            "/infoservice/typelist.do?paraFlag=3&#38;nodeid=null");
        staticVO4.setNodename("部门信息");
        staticVO4.setIsfolder("1");
        staticVO4.setSrc(
            "/infoservice/typetree.do?action=doTreeData&#38;paraFlag=3");
        ...
        staticVO5.setAction(
            "/infoservice/typelist.do?paraFlag=4&#38;nodeid=null");
        staticVO5.setNodename("报告管理");
        staticVO5.setIsfolder("1");
        staticVO5.setSrc(
            "/infoservice/typetree.do?action=doTreeData&#38;paraFlag=4");
        ...
        staticVO6.setAction(
            "/infoservice/typelist.do?paraFlag=5&#38;nodeid=null");
        staticVO6.setNodename("行业新闻");
        staticVO6.setIsfolder("1");
        staticVO6.setSrc(
            "/infoservice/typetree.do?action=doTreeData&#38;paraFlag=5");
        ...
        staticVO7.setAction(
            "/infoservice/typelist.do?paraFlag=6&#38;nodeid=null");
        staticVO7.setNodename("管理制度");
        staticVO7.setIsfolder("1");
        staticVO7.setSrc(
            "/infoservice/typetree.do?action=doTreeData&#38;paraFlag=6");
        ...
        staticVO8.setAction(
            "/infoservice/typelist.do?paraFlag=7&#38;nodeid=null");
        staticVO8.setNodename("文档资料");
        staticVO8.setIsfolder("1");
        staticVO8.setSrc(
            "/infoservice/typetree.do?action=doTreeData&#38;paraFlag=7");
    ...
    protected String doUpdate(GoaActionConfig cfg, boolean isBack)
        ...
        try {
            ...
            throw new DefaultException("类别名称已存在,请重新输入！");
    ...
    public String doDelete(GoaActionConfig cfg)
        throws DefaultException, Exception {
        String forword = null;
        ...
        try {
            ...
            if (e.getMessage().equals("PK")) {
                cfg.getRequest().setAttribute("ErrorMsg",
                    "该类别下已存在信息，请先删除该类别下存在的信息，再删除该类别！");
