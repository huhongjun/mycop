...
import com.gever.goa.dailyoffice.worklog.vo.PersonWeekTargetTreeVO;
...
public class PersonWeekTargetDaoImpl extends BaseDAO implements PersonWeekTargetDao {
...
//QUERY_SQL--定义翻页时用的查询语句
    public PersonWeekTargetDaoImpl(String dbData) {
        super(dbData);
    }
    ...
    public List getTreeData(String nodeid,String curDeptId) throws DefaultException {
        ...
        PersonWeekTargetTreeVO vo = new PersonWeekTargetTreeVO();
