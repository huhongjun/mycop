...
public class BBSMainAction extends BaseAction {
  ...
  protected void initData(GoaActionConfig cfg) throws DefaultException,
        Exception {
       BBSDAO  DAO= BBSFactory.getInstance().createDAO(super.dbData); //得到相对应dao的实例
   ...
   public String toMain(GoaActionConfig cfg) throws DefaultException,
        Exception {
   ...
   public String doTopTreeData(GoaActionConfig cfg) throws DefaultException,
        Exception{
        BBSDAO  DAO= BBSFactory.getInstance().createDAO(super.dbData);
    ...
    public String doSTreeData(GoaActionConfig cfg) throws DefaultException,
        Exception{
        BBSDAO  DAO= BBSFactory.getInstance().createDAO(super.dbData);
