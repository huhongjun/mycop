...
import com.gever.goa.dailyoffice.worklog.vo.PersonYearTargetTreeVO;
...
public class PersonYearTargetDaoImpl extends BaseDAO implements PersonYearTargetDao {
...
//QUERY_SQL--定义翻页时用的查询语句
    public PersonYearTargetDaoImpl(String dbData) {
        super(dbData);
    }
    ...
    public List getTreeData(String nodeid,String curDeptId) throws DefaultException {
         ...
         PersonYearTargetTreeVO vo = new PersonYearTargetTreeVO();
