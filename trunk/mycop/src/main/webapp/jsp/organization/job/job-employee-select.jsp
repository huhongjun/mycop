...
<input type="hidden" name="userID" value="<%=(String)request.getAttribute("userID")%>" onsubmit="javascript:return false;">
<table align="center">
  <tr>
    <td >&nbsp;</td>
  </tr>
  ...
  <tr>
    <td align="center" >
      <html:submit  styleClass="button"  property="create" value="确定" onclick="setSubmitAble();toSelectAction(this,'addRightListBox','userIds','setJobUser')"/>
	...
	<html:hidden name="JobForm" property="id"/>
...
function initUserArray() {
	var index = 0;
	<logic:iterate id="element" name="unJobUsers"  indexId="index">
	...
	<logic:iterate id="element" name="jobUsers">
	userArray[index] = new User("<bean:write name="element" property="id"/>","<bean:write name="element" property="name"/>","<bean:write name="element" property="userName"/>");
