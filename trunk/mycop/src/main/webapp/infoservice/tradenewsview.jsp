...
<html:form action="/infoservice/tradenewsview" method="post" enctype="multipart/form-data">
<span id="idSpanTop" class="TableTitleText"><br></span> 

<table id="idTBTittle" width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
        <td align="center"><span class="TableTitleText">行业新闻浏览</span></td>
    </tr>
    <tr> 
...
<table width="95%" align="center">
	...
	<tr class="listcellrow">
		...
		<td>
		<goa:write  name="IsInfoServeForm3" property="vo.title" filter="true"/>
		</td>
		<td>&nbsp;</td>
		<td align="right" class="InputLabelCell">类&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
		<td>
		<goa:write  name="IsInfoServeForm3" property="vo.info_type" filter="true"/>
		</td>
	</tr>	
	<tr class="listcellrow">
		<td align="left" class="InputLabelCell">发 布 人：</td>
		<td>
		<goa:write  name="IsInfoServeForm3" property="vo.user_name" filter="true"/>
		</td>
		<td>&nbsp;</td>
		<td align="right" class="InputLabelCell">发布时间：</td>
		<td>
		<goa:write  name="IsInfoServeForm3" property="vo.create_date" filter="true"/>
		</td>
	</tr>
	<tr class="listcellrow">
		...
		<td colspan="4">
		<% 
		 IsInfoServeForm dForm = (IsInfoServeForm)session.getAttribute("IsInfoServeForm3");
	...
	<tr class="listcellrow">
		...
		<td colspan="4">
		<!--goa:write  name="IsInfoServeForm3" property="vo.content" filter="true"/-->
		</td>
	</tr>
</table>
</td>
...
<table id="idTBBottom" width="95%" border="0" cellspacing="0" cellpadding="0" style="POSITION:absolute; left: 0px; top: 610px;">
    ...
    <tr> 
        <td align="center"> 
		<html:hidden name="IsInfoServeForm3" property="fid" />
		<%String clk1="toUrl('"+context+"/infoservice/tradenewsedit.do?actionType=modify',false)";%>
