...
<html>
<body class="bodybg">
<html:form action="/infoservice/docinfoedit" method="post" enctype="multipart/form-data">
<span class="TableTitleText"><br></span> 

<table width="95%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
        <td align="center"><span class="TableTitleText">文档资料编辑</span></td>
    </tr>
    <tr> 
...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
        <td align="center"> 
		<goa:button property="save" value="保存" styleClass="button"  onclick="return doSave(IsInfoManageForm3)" operation="WDZL.OPT"/>
		<goa:button property="save" value="保存并返回" styleClass="button"  onclick="return doSaveExit(IsInfoManageForm3)" operation="WDZL.OPT"/>
