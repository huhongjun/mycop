...
<html:form action="/dailyoffice/targetmng/viewweektarget" method="post">
...
<TR>
    <TD colspan="8" align="center" class="TableTitleText"><bean:write  name="WeekTargetForm" property="vo.current_year" filter="true"/>年<bean:write  name="WeekTargetForm" property="vo.current_month" filter="true"/>月<bean:write  name="WeekTargetForm" property="vo.current_work" filter="true"/>周目标</TD>	
</TR>
...
<TR class="listcellrow">
	...
	<TD width="40%">&nbsp;</TD>
	<TD width="30%">部门：<bean:write  name="WeekTargetForm" property="deptname" filter="true"/></TD>
</TR>	
</TABLE>
...
<TABLE id="idTBBottom" style="POSITION:absolute; left: 5px; top: 199px;" cellpadding='0' cellspacing='0' width="100%">
	...
	<TD width="30%">
	  审　　核：<bean:write  name="WeekTargetForm" property="auditorname" filter="true"/>	  
	</TD>
	<TD width="30%">
	  审　　批：<bean:write  name="WeekTargetForm" property="checkername" filter="true"/>	  
	</TD>
     </TR>
	 <TR class="listcellrow" align="left">
		<TD width="30%">
     ...
     <tr>
        <td align="center" colspan="8">	  
		  <logic:equal name="WeekTargetForm" property="isCancel" value = "1">
		 <goa:button operation="MZMB.OPT" property="save" value="取消审核" styleClass="button"  onclick="doCancel()"/>	
		 </logic:equal>
		   <logic:equal name="WeekTargetForm" property="isCancel" value = "2">
		 <goa:button operation="MZMB.OPT" property="save" value="取消审批" styleClass="button"  onclick="doCancel()"/>	
		 </logic:equal>
        <logic:equal name="WeekTargetForm" property="modifyFlag" value = "1">
        <% String temp="toUrl('"+context+"/dailyoffice/targetmng/editweektarget.do?actionType=modify&flag=modify',false)";%>
		 <goa:button operation="MZMB.OPT" property="save" value="修改" styleClass="button"  onclick="<%=temp%>"/>	
		 </logic:equal>
		 <logic:equal name="WeekTargetForm" property="creatorFlag" value = "2">   
		 <% String temp1="toUrl('"+context+"/dailyoffice/targetmng/editweektarget.do?actionType=modify',false)";%>
		 <goa:button operation="MZMB.OPT" property="save" value="审核" styleClass="button"  onclick="<%=temp1%>"/>	</logic:equal>
		 <logic:equal name="WeekTargetForm" property="creatorFlag" value = "3">   
		 <% String temp2="toUrl('"+context+"/dailyoffice/targetmng/editweektarget.do?actionType=modify',false)";%>
		 <goa:button operation="MZMB.OPT" property="save" value="审批" styleClass="button"  onclick="<%=temp2%>"/>	</logic:equal>
