...
function window.onload() {
	...
	<logic:equal name="WeekTargetForm" property="actionType" value = "add">
	CellWeb1.OpenFile(getUrl() + "<bean:write  name="WeekTargetForm" property="reportTemplateName" filter="true"/>","");
	</logic:equal>
	<logic:equal name="WeekTargetForm" property="actionType" value = "modify">
	CellWeb1.OpenFile( getUrl() + "<bean:write  name="WeekTargetForm" property="cellname" filter="true"/>","");
	</logic:equal>
	...
	<logic:equal name="WeekTargetForm" property="isReadOnlyTemplateFlag" value = "0">
...
function check(){
	...
	<logic:equal name="WeekTargetForm" property="editFlag" value="1">
...
<html:form action="/dailyoffice/targetmng/editweektarget" method="post">
<TABLE id="idTRTop" cellpadding='0' cellspacing='0' width="100%">
  <html:hidden property="cellcontent"/>
  <html:hidden name="WeekTargetForm" property="actionType"/> 
  <html:hidden name="WeekTargetForm" property="auditorid"/> 
  <html:hidden name="WeekTargetForm" property="checkerid"/>   
  <html:hidden name="WeekTargetForm" property="vo.user_code"/>
  <html:hidden name="WeekTargetForm" property="isSendMsg"/>
<TR>   
    <logic:equal name="WeekTargetForm" property="actionType" value = "add">
	<TD colspan="8" align="center" class="TableTitleText"><bean:write  name="WeekTargetForm" property="vo.current_year" filter="true"/>年<html:text  styleClass="input9" property="vo.current_month"  onlytype="int" size="2" maxlength="2"/>月<html:text styleClass="input9" property="vo.current_work" onlytype="int" size="2" maxlength="1"/>周目标</TD>
	</logic:equal>
	<logic:equal name="WeekTargetForm" property="actionType" value = "modify">
	<TD colspan="8" align="center" class="TableTitleText"><bean:write  name="WeekTargetForm" property="vo.current_year" filter="true"/>年<bean:write  name="WeekTargetForm" property="vo.current_month" filter="true"/>月<html:text styleClass="input9"  property="vo.current_work" onlytype="int" size="2" maxlength="1"/>周目标</TD>
	</logic:equal>
</TR>
...
<TR class="listcellrow">
    <TD width="1%">&nbsp;</TD>
    <TD width="29%"><bean:write  name="WeekTargetForm" property="unitname" filter="true"/>&nbsp;</TD>
	<TD width="40%">&nbsp;</TD>
	<TD width="30%" align="left">部门：<bean:write  name="WeekTargetForm" property="deptname" filter="true"/></TD>
</TR>	
</TABLE>
...
<TABLE id="idTBBottom" style="POSITION:absolute; left: 5px; top: 199px;" cellpadding='0' cellspacing='0' width="100%">
	...
	<TD colspan="8" align="left">&nbsp;</TD>	
     ...
     <logic:equal name="WeekTargetForm" property="auditFlag" value = "1">
     <TR class="listcellrow">
	 <TD colspan="8" align="left">
	 审核意见：<html:text styleClass="input2" property="vo.audit_opinion" size="95" maxlength="100"/>
	 <logic:equal name="WeekTargetForm" property="auditFlag" value = "1">
		  <input type="radio" name="vo.audit_flag" value="1" width="15%" checked>通过
		  </logic:equal>
		  <logic:equal name="WeekTargetForm" property="checkFlag" value = "1">
     ...
     <TR class="listcellrow" align="left">
		<TD width="30%">
		编　　制：<bean:write  name="WeekTargetForm" property="username" filter="true"/>	  
		</TD>
		<TD width="40%" >  
		  审　　核：
          <logic:equal name="WeekTargetForm" property="editFlag" value = "1">
		  <html:text property="auditorname" size="10" readonly="true"  styleClass="input2"/>	</logic:equal>
		  <logic:equal name="WeekTargetForm" property="editFlag" value = "0">
		  <html:hidden  name="WeekTargetForm" property="auditorname" />
		  <bean:write  name="WeekTargetForm" property="auditorname" filter="true"/>
          </logic:equal>
		  &nbsp;
		  <logic:equal name="WeekTargetForm" property="editFlag" value = "1">
		...
		<TD width="30%" align="left">
		  ...
		  <logic:equal name="WeekTargetForm" property="editFlag" value = "0">
		  <html:hidden  name="WeekTargetForm" property="checkername" />
		  <bean:write  name="WeekTargetForm" property="checkername" filter="true"/>
		  </logic:equal>
		  &nbsp;
		  <logic:equal name="WeekTargetForm" property="editFlag" value = "1">
	 ...
	 <TR class="listcellrow" align="left">
		<TD width="20%">
		编制日期：<bean:write  name="WeekTargetForm" property="vo.create_date" filter="true"/>
		</TD>
		<TD width="30%" >
		审核日期：<bean:write  name="WeekTargetForm" property="vo.audit_date" filter="true"/>
		</TD>
		<TD width="40%" align="left">
		审批日期：<bean:write  name="WeekTargetForm" property="vo.check_date" filter="true"/>
		</TD>
