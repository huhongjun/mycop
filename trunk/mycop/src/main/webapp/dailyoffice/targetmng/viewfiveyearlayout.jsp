...
<html:form action="/dailyoffice/targetmng/viewfiveyearlayout" method="post">
...
<TABLE id="idTBBottom" style="POSITION:absolute; left: 5px; top: 199px;" cellpadding='0' cellspacing='0' width="100%">
	...
	<TD width="20%">
	  批    准：<bean:write  name="FiveYearLayoutForm" property="approvename" filter="true"/>	  
	</TD>     
	<TD width="20%" >
	  批准日期：	  
     ...
     <tr>
        <td align="center" colspan="8">	
		   <logic:equal name="FiveYearLayoutForm" property="isCancel" value = "2">
		 <goa:button operation="MZMB.OPT" property="cancelCheck" value="取消审批" styleClass="button"  onclick="doCancel()"/>	
		 </logic:equal>
         <logic:equal name="FiveYearLayoutForm" property="modifyFlag" value = "1">
         <% String temp="toUrl('"+context+"/dailyoffice/targetmng/editfiveyearlayout.do?actionType=modify&flag=modify',false)";%>
         <goa:button operation="WRJF.OPT" property="modify" value="修改" styleClass="button"  onclick="<%=temp%>"/>
         </logic:equal>
		 <logic:equal name="FiveYearLayoutForm" property="creatorFlag" value = "2">
		 <% String temp1="toUrl('"+context+"/dailyoffice/targetmng/editfiveyearlayout.do?actionType=modify',false)";%>
         <goa:button operation="WRJF.OPT" property="check" value="审批" styleClass="button"  onclick="<%=temp1%>"/>
         </logic:equal>
		 <goa:button operation="WRJF.VIEW" property="exit" value="返回" styleClass="button" onclick="doAction('goUrl(index)')"/>
		 <goa:button operation="WRJF.VIEW" property="exit" value="打印预览" styleClass="button" onclick="mnuFilePrintPreview_click()"/>
		 <goa:button operation="WRJF.VIEW" property="exit" value="导出到Excel文件" styleClass="button" onclick="mnuFileExportExcel_click()"/>
        </td>
        </td>
     </tr>
</TABLE>
