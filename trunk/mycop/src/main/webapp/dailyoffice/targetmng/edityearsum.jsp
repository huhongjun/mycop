...
function window.onload() {
	...
	<logic:equal name="YearSumForm" property="actionType" value = "add">
	CellWeb1.OpenFile(getUrl() + "<bean:write  name="YearSumForm" property="reportTemplateName" filter="true"/>","");
	</logic:equal>
	<logic:equal name="YearSumForm" property="actionType" value = "modify">
	CellWeb1.OpenFile( getUrl() + "<bean:write  name="YearSumForm" property="cellname" filter="true"/>","");
	</logic:equal>
	...
	<logic:equal name="YearSumForm" property="isReadOnlyTemplateFlag" value = "0">
...
function check(){
	...
	<logic:equal name="YearSumForm" property="editFlag" value="1">
...
<html:form action="/dailyoffice/targetmng/edityearsum" method="post">
<TABLE id="idTRTop" cellpadding='0' cellspacing='0' width="100%">
  <html:hidden property="cellcontent"/>
  <html:hidden name="YearSumForm" property="auditorid"/> 
  <html:hidden name="YearSumForm" property="checkerid"/>   
  <html:hidden name="YearSumForm" property="actionType"/> 
  <html:hidden name="YearSumForm" property="vo.user_code"/>
  <html:hidden name="YearSumForm" property="isSendMsg"/>
<TR>
    <logic:equal name="YearSumForm" property="actionType" value = "add">
	<TD colspan="8" align="center" class="TableTitleText">
	<html:text styleClass="input9" property="vo.current_year" onlytype="int" size="4" maxlength="4"/>年度总结</TD>
	</logic:equal>
	<logic:equal name="YearSumForm" property="actionType" value = "modify">
	<TD colspan="8" align="center" class="TableTitleText"><html:hidden  name="YearSumForm" property="vo.current_year" /><bean:write name="YearSumForm" property="vo.current_year" filter="true"/>年度总结</TD>
	</logic:equal>
</TR>
...
<TR class="listcellrow">
<TD width="1%">&nbsp;</TD>
        <TD width="29%"><bean:write  name="YearSumForm" property="unitname" filter="true"/>&nbsp;</TD>
	<TD width="40%">&nbsp;</TD>
	<TD width="30%">部门：<bean:write  name="YearSumForm" property="deptname" filter="true"/></TD>
</TR>	
</TABLE>
...
<TABLE id="idTBBottom" style="POSITION:absolute; left: 5px; top: 199px;" cellpadding='0' cellspacing='0' width="100%">
	...
	<TD colspan="8" align="left">&nbsp;</TD>	
	 ...
	 <logic:equal name="YearSumForm" property="auditFlag" value = "1">
     <TR class="listcellrow">
	 <TD colspan="8" align="left">审核意见：<html:text styleClass="input2" property="vo.audit_opinion" size="95" maxlength="100"/>
	  <logic:equal name="YearSumForm" property="auditFlag" value = "1">
		  ...
		  <logic:equal name="YearSumForm" property="checkFlag" value = "1">
     ...
     <TR class="listcellrow" align="left">
		<TD width="30%">
		编　　制：<bean:write  name="YearSumForm" property="username" filter="true"/>	  
		</TD>
		<TD width="40%" >  
		  审　　核：
          <logic:equal name="YearSumForm" property="editFlag" value = "1">
		  <html:text property="auditorname" size="10" readonly="true"  styleClass="input2"/>	</logic:equal>
		  <logic:equal name="YearSumForm" property="editFlag" value = "0">
		  <html:hidden  name="YearSumForm" property="auditorname" />
		  <bean:write  name="YearSumForm" property="auditorname" filter="true"/>
          </logic:equal>
		  &nbsp;
		  <logic:equal name="YearSumForm" property="editFlag" value = "1">
		...
		<TD width="30%">
		  ...
		  <logic:equal name="YearSumForm" property="editFlag" value = "0">
		  <html:hidden  name="YearSumForm" property="checkername" />
		  <bean:write  name="YearSumForm" property="checkername" filter="true"/>
		  </logic:equal>
		  &nbsp;
		  <logic:equal name="YearSumForm" property="editFlag" value = "1">
	 ...
	 <TR class="listcellrow" align="left">
		<TD width="20%">
		编制日期：<bean:write  name="YearSumForm" property="vo.create_date" filter="true"/>
		</TD>
		<TD width="30%" >
		审核日期：<bean:write  name="YearSumForm" property="vo.audit_date" filter="true"/>
		</TD>
		<TD width="30%">
		审批日期：<bean:write  name="YearSumForm" property="vo.check_date" filter="true"/>
		</TD>
     </TR>
     <TR>
	<TD colspan="8" align="left">&nbsp;</TD>	
     ...
     <tr>
	  ...
	  <goa:button operation="NDZJ.OPT" property="save" value="保存" styleClass="button"  onclick="toSave()"/>	
	  <goa:button operation="NDZJ.OPT" property="saveAndExit" value="保存并返回" styleClass="button"  onclick="saveExit()"/>	  
	  <goa:button operation="NDZJ.OPT" property="reset" value="取消" styleClass="button"  onclick="pageUndo()"/>
          <goa:button operation="NDZJ.VIEW" property="exit" value="返回" styleClass="button" onclick="doAction('goUrl(index)')"/></td>
     </tr>
</TABLE>
</html:form>
</BODY>
