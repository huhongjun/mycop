...
<html>
<body class="bodybg">
  <html:form action="/dailyoffice/targetmng/listyearsum" method="post">
  <table width="95%" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr> 
    <td colspan="6">&nbsp;</td>
  </tr>
  <tr> 
    <td colspan="8" align="center" class="TableTitleText">年度总结列表</td>
  </tr>
  <tr> 
    ...
    <td class="f12" colspan="6" align="right">
	 <table border="0" cellspacing="1" cellpadding="2">
        <tr>
		  ...
		  <td>
		   <% String temp="doQuery('"+context+"/dailyoffice/targetmng/listyearsum.do',true)";%>
	  <goa:button operation="NDZJ.VIEW" styleClass="button"  property="query" onclick="<%=temp%>" value="查询"/>
          </td> 
          <td><goa:button operation="NDZJ.OPT" styleClass="button"  property="add" onclick="doAdd()" value="新增"/></td>          
          <td>
          <% String temp1="toUrl('"+context+"/dailyoffice/targetmng/edityearsum.do?actionType=modify&flag=modify',true)";%>
	  <goa:button operation="NDZJ.OPT" styleClass="button"  property="modify" onclick="<%=temp1%>" value="修改"/>
          </td> 
          <td> 
		  <goa:button operation="NDZJ.OPT"  styleClass="button" property="delete" onclick="doDelete()"  value="删除"/>
          </td>		  
        </tr>
      </table>
	  </td>
  ...
  <tr> 
    ...
    <logic:iterate id="ps" name="YearSumForm" property="pageControl.data" type="com.gever.goa.dailyoffice.targetmng.vo.TargetVO" indexId="index">
	<tr  onmouseover="javascript:changeBgColorOnMouseOver(this);" onmouseout="javascript:changeBgColorOnMouseOut(this);" ondblclick="<%="toUrl('"+context+"/dailyoffice/targetmng/viewyearsum.do?fid=" +ps.getSerial_num()+"',false)"%>">
		...
		<% String link_url = ""+context+"/dailyoffice/targetmng/viewyearsum.do?fid=" +ps.getSerial_num(); %>
  ...
  <tr> 
    <td colspan="8" align="center" class="f12">
	    <html:hidden name="YearSumForm" property="orderType"/>
        <html:hidden name="YearSumForm" property="orderFld"/>
		<goa:pagelink name="YearSumForm" property="pageControl" /> 
		</td>
	  </tr>
	</table>
</html:form>
