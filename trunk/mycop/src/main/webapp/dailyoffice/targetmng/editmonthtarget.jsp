...
function window.onload() {
	...
	<logic:equal name="MonthTargetForm" property="actionType" value = "add">
	CellWeb1.OpenFile(getUrl() + "<bean:write  name="MonthTargetForm" property="reportTemplateName" filter="true"/>","");
	</logic:equal>
	<logic:equal name="MonthTargetForm" property="actionType" value = "modify">
	CellWeb1.OpenFile( getUrl() + "<bean:write  name="MonthTargetForm" property="cellname" filter="true"/>","");
	</logic:equal>
	...
	//华表样式的宽度
	var lHeight = document.body.offsetHeight - 150 - parseInt(CellWeb1.style.top);
	...
	<logic:equal name="MonthTargetForm" property="isReadOnlyTemplateFlag" value = "0">
...
function check(){
	...
	<logic:equal name="MonthTargetForm" property="editFlag" value="1">
...
<html:form action="/dailyoffice/targetmng/editmonthtarget" method="post">
<TABLE id="idTRTop" cellpadding='0' cellspacing='0' width="100%">
  <html:hidden property="cellcontent"/>
  <html:hidden name="MonthTargetForm" property="actionType"/> 
  <html:hidden name="MonthTargetForm" property="auditorid"/> 
  <html:hidden name="MonthTargetForm" property="checkerid"/>   
  <html:hidden name="MonthTargetForm" property="vo.user_code"/>
  <html:hidden name="MonthTargetForm" property="isSendMsg"/>
<TR>
    <logic:equal name="MonthTargetForm" property="actionType" value = "add">
	<TD colspan="8" align="center" class="TableTitleText"><bean:write  name="MonthTargetForm" property="vo.current_year" filter="true"/>年<html:text name="MonthTargetForm" styleClass="input9" property="vo.current_month" onlytype="int" size="2" maxlength="2"/>月目标</TD>
	</logic:equal>
	<logic:equal name="MonthTargetForm" property="actionType" value = "modify">
	<TD colspan="8" align="center" class="TableTitleText"><bean:write  name="MonthTargetForm" property="vo.current_year" filter="true"/>年<html:text name="MonthTargetForm" styleClass="input9" property="vo.current_month" onlytype="int" size="2" maxlength="2"/>月目标</TD>
	</logic:equal>
...
<TR class="listcellrow">
    <TD width="1%">&nbsp;</TD>
    <TD width="29%"><bean:write  name="MonthTargetForm" property="unitname" filter="true"/>&nbsp;</TD>
	<TD width="40%">&nbsp;</TD>
	<TD width="30%">部门：<bean:write  name="MonthTargetForm" property="deptname" filter="true"/>&nbsp;</TD>
</TR>	
</TABLE>
...
<TABLE id="idTBBottom" style="POSITION:absolute; left: 5px; top: 199px;" cellpadding='0' cellspacing='0' width="100%">
	...
	<TD colspan="8" align="left">&nbsp;</TD>	
	 ...
	 <logic:equal name="MonthTargetForm" property="auditFlag" value = "1">
     <TR class="listcellrow">
	 ...
	 <logic:equal name="MonthTargetForm" property="auditFlag" value = "1">
		  ...
		  <logic:equal name="MonthTargetForm" property="checkFlag" value = "1">
     ...
     <TR class="listcellrow" align="left">
		<TD width="30%">
		编　　制：<bean:write  name="MonthTargetForm" property="username" filter="true"/>	  
		</TD>
		<TD width="40%" >  
		  审　　核：
          <logic:equal name="MonthTargetForm" property="editFlag" value = "1">
		  <html:text property="auditorname" size="10" readonly="true"  styleClass="input2"/>	</logic:equal>
		  <logic:equal name="MonthTargetForm" property="editFlag" value = "0">
		  <html:hidden  name="MonthTargetForm" property="auditorname" />
		  <bean:write  name="MonthTargetForm" property="auditorname" filter="true"/>
          </logic:equal>
		  &nbsp;
		  <logic:equal name="MonthTargetForm" property="editFlag" value = "1">
		...
		<TD width="30%">
		  ...
		  <logic:equal name="MonthTargetForm" property="editFlag" value = "0">
		  <html:hidden  name="MonthTargetForm" property="checkername" />
		  <bean:write  name="MonthTargetForm" property="checkername" filter="true"/>
		  </logic:equal>
		  &nbsp;
		  <logic:equal name="MonthTargetForm" property="editFlag" value = "1">
	 ...
	 <TR class="listcellrow" align="left">
		<TD width="20%">
		编制日期：<bean:write  name="MonthTargetForm" property="vo.create_date" filter="true"/>
		</TD>
		<TD width="30%" >
		审核日期：<bean:write  name="MonthTargetForm" property="vo.audit_date" filter="true"/>
		</TD>
		<TD width="30%">
		审批日期：<bean:write  name="MonthTargetForm" property="vo.check_date" filter="true"/>
		</TD>
     </TR>
     <TR>
	<TD colspan="8" align="left">&nbsp;</TD>	
     ...
     <tr>
	  ...
	  <goa:button operation="YDMB.OPT" property="save" value="保存" styleClass="button"  onclick="toSave()"/>	
	  <goa:button operation="YDMB.OPT" property="saveAndExit" value="保存并返回" styleClass="button"  onclick="saveExit()"/>	  
	  <goa:button operation="YDMB.OPT" property="reset" value="取消" styleClass="button"  onclick="pageUndo()"/>
          <goa:button operation="YDMB.VIEW" property="exit" value="返回" styleClass="button" onclick="doAction('goUrl(index)')"/></td>
     </tr>
</TABLE>
</html:form>
</BODY>
