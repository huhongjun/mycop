	 ...
	 <table border="0" cellspacing="1" cellpadding="2">
        <tr>
          ...
          <td> <goa:button styleClass="button"  property="add" onclick="doAdd()" value="新增"  operation="TSGL.OPT"/>
		   ...
		   <goa:button styleClass="button"  property="copy" onclick="toUrl('../qiqu/Book/editBook.do?actionType=modify',true)" value="修改" operation="TSGL.OPT"/>
          </td>
		   <td> <goa:button  styleClass="button" property="delete" value="删除"  onclick="doDelete()" operation="TSGL.OPT"/>
		    <td> <goa:button  styleClass="button" property="delete" value="查看"  onclick="toUrl('../qiqu/Book/viewBook.do',true)" operation="TSGL.VIEW"/>
...
<logic:iterate id="ps" name="BookForm" property="pageControl.data" type="com.gever.goa.book.vo.BookVO" indexId="index">
	   <tr  onmouseover="javascript:changeBgColorOnMouseOver(this);" onmouseout="javascript:changeBgColorOnMouseOut(this);" ondblclick="<%="toUrl('../qiqu/Book/viewBook.do?fid=" +ps.getValue("bookid")+ "',false)"%>">
