...
<div align="center">
  <center>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr> 
        <td align="center"><span class="TableTitleText">政治面貌</span></td>
      </tr>
      <tr> 
        ...
        <td align="center">
				...
				<tr> 
				  ...
				  <table width="400" height="36" border="0" align="center"  cellpadding="2" cellspacing="1">
                  			<tr height="23">
					    <td  width="120" height="23" nowrap class="InputLabelCell">政治面貌代码：</td>
					    <td  width="383" height="23" class="f12"><bean:write  name="PolityForm" property="vo.polity_code" filter="true"/></td>
					</tr>
					<tr height="23">
					    <td  width="86" height="23" nowrap class="InputLabelCell">政&nbsp;治&nbsp;面&nbsp;貌：</td>
      ...
      <tr> 
		...
		<goa:button property="save" value="修改" styleClass="button"  onclick="toUrl('../admin/editpolity.do?actionType=modify',false)" operation="ZZMM.OPT"/>
