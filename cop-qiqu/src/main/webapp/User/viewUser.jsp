	...
	<td align="center">
      ...
      <tr> 
        <td align="center"> 
		        ...
		        <goa:button property="save" value="ÐÞ¸Ä" styleClass="button"  onclick=" toUrl('../User/editUser.do?actionType=modify',false)" operation="${entity.resoperationcode_edit}"/>
        <goa:button property="exit" value="·µ»Ø" styleClass="button" onclick="doAction('goUrl(index)')" operation="${entity.resoperationcode_view}"/></td>
      </tr>
    </table>
    </center>
</div>
