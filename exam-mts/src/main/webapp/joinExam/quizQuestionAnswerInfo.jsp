...
%>
  <tr>
            <td width="52">第<%=i + 1 %>题</td>
            <td height="22" colspan="2" align="left"><%=question.getQuestioncontext() %>（<%=quizQuestion.getGrade() %>分）<input type="text" name="<%=quizAnswers.getId() %>" value="<%=score %>" size="3" maxlength="4" title="<%=quizQuestion.getGrade() %>">分 <input type="button" name="Submit2" value="保存" onclick="saveScore1('<%=quizAnswers.getId() %>')"/></td>
        </tr>
<%
...
%>
          <tr>
            ...
            <td width="755" align="left">
   				<span class="style6">答案：<%=userAnswers %></span><br>
				<span class="style3">参考答案：<%=rightAnswers %></span><br>
				<span class="style5"><span class="style5">得分：<input type="text" name="<%=sonQuestion.getId() %>" value="<%=_score %>" size="3" maxlength="4" title="<%=score1 %>">分 <input type="button" name="Submit2" value="保存" onclick="saveScore1('<%=sonQuestion.getId() %>')"/></span>
            </td>
            <td width="125"></td>
          </tr>
<%
